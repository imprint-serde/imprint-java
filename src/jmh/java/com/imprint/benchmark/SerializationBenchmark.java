...
public class SerializationBenchmark {
    ...
    private ImprintRecord createSmallRecord() throws Exception {
        ...
        return ImprintRecord.builder(new SchemaId(1, 0x12345678))
            ...
            .field(3, Value.fromFloat64(99.99))
            .field(4, Value.fromBoolean(true))
    ...
    private ImprintRecord createMediumRecord() throws Exception {
        ...
        builder.field(1, Value.fromString("Product"));
        builder.field(2, Value.fromInt32(12345));
        builder.field(3, Value.fromFloat64(99.99));
        builder.field(4, Value.fromBoolean(true));
        builder.field(5, Value.fromString("Electronics"));
        ...
        builder.field(6, Value.fromArray(tags));
        ...
        builder.field(7, Value.fromMap(metadata));
        
        // Add more fields for medium size
        for (int i = 8; i <= 50; i++) {
            builder.field(i, Value.fromString("field_" + i + "_value"));
        }
    ...
    private ImprintRecord createLargeRecord() throws Exception {
        ...
        builder.field(1, Value.fromString("LargeProduct"));
        builder.field(2, Value.fromInt32(12345));
        builder.field(3, Value.fromFloat64(99.99));
        ...
        builder.field(4, Value.fromArray(largeArray));
        ...
        builder.field(5, Value.fromMap(largeMap));
        
        // Many string fields
        for (int i = 6; i <= 200; i++) {
            builder.field(i, Value.fromString("this_is_a_longer_field_value_for_field_" + i + "_to_increase_record_size"));
        }
